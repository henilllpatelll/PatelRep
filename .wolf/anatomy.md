...
- `MEMORY.md` — PatelRep Project Memory (~682 tok)
- `project_ci_gaps.md` — Declares of (~558 tok)
- `reference_railway.md` — Railway Infrastructure (~1048 tok)
...
- `summary_body.txt` — Project Research Summary (~4423 tok)

## ../../AppData/Local/Temp/claude/C--Users-Henil-projects-PatelRep/43800a8c-8f39-4095-b7dc-9e944fe16f8c/scratchpad/

- `check-fixture.mjs` — Declares envText (~179 tok)

## ../../AppData/Local/Temp/claude/C--Users-Henil-projects-PatelRep/5403344f-9ec2-4ed7-add7-5758369d4935/scratchpad/

- `check_col.mjs` — Declares loadEnvFile (~265 tok)
- `gen-matrix.ts` — Declares ROLES (~129 tok)
- `live-verify.mjs` — BASE: log, login, main (~1956 tok)
- `summary_payload.txt` — Project Research Summary (~5066 tok)
- `verify-sidebar.mjs` — Declares BASE (~1016 tok)
...
- `flip-flag.mjs` — Declares action (~228 tok)
- `verify35.mjs` — Live verification script for Phase 35 close-out (35-07 Task 3). (~2520 tok)

## ../../AppData/Local/Temp/claude/C--Users-Henil-projects-PatelRep/a1e4b068-4abc-4d3e-a1fc-36f3339c3040/scratchpad/34-08-verify/

- `login.mjs` — Declares BASE (~270 tok)
...
- `update_state.js` — Declares fs (~968 tok)
- `verify-28-04.js` — Declares browser (~960 tok)
- `verify-panel.js` — Declares browser (~621 tok)
...
- `CLAUDE.md` — OpenWolf (~3579 tok)
- `verify-28-04-tmp.js` — Declares browser (~1079 tok)
...
- `ci.yml` — CI: CI (~2584 tok)
- `deploy-check.yml` — CI: Deploy Health Check (~620 tok)

## .planning/

- `MILESTONES.md` — Project Milestones: PatelRep (~4816 tok)
- `PROJECT.md` — PatelRep (~11867 tok)
- `REQUIREMENTS.md` — Requirements: PatelRep — v2.0 Web UI/UX Redesign (~2283 tok)
- `ROADMAP.md` — Roadmap: PatelRep (~5778 tok)
- `STATE.md` — GSD State (~65906 tok)
- `v1.5-MILESTONE-AUDIT.md` — v1.5 "RBAC Enforcement Tooling" — Milestone Audit (~1736 tok)
- `v1.7-MILESTONE-AUDIT.md` — Milestone v1.7 Audit: AI Copilot Batch Actions & Escalation (~1315 tok)
...
- `25-01-PLAN.md` — --------------------------------------------------------------------------- (~4755 tok)
- `25-01-SUMMARY.md` — Dependency graph (~2383 tok)
- `25-CONTEXT.md` — Phase 25: Failure-Prediction Proactive Push + Dedup - Context (~1859 tok)
- `25-RESEARCH.md` — Phase 25: Failure-Prediction Proactive Push + Dedup - Research (~7400 tok)
- `25-VERIFICATION.md` — Phase 25: Failure-Prediction Proactive Push + Dedup Verification Report (~2129 tok)

## .planning/phases/26-deep-linked-alert-surfaces/

- `26-01-PLAN.md` — Declares Plan (~2046 tok)
- `26-01-SUMMARY.md` — Dependency graph (~1486 tok)
- `26-02-PLAN.md` — Declares of (~5157 tok)
- `26-02-SUMMARY.md` — Dependency graph (~3327 tok)
- `26-CONTEXT.md` — Phase 26: Deep-Linked Alert Surfaces - Context (~2172 tok)
- `26-RESEARCH.md` — Phase 26: Deep-Linked Alert Surfaces - Research (~7133 tok)
- `26-VERIFICATION.md` — Phase 26: Deep-Linked Alert Surfaces Verification Report (~2736 tok)

## .planning/phases/27-room-readiness-one-click-reassign-escalate-acknowledge/

- `27-01-PLAN.md` — Declares extension (~1883 tok)
- `27-01-SUMMARY.md` — Dependency graph (~1301 tok)
- `27-02-PLAN.md` — Declares entirely (~7639 tok)
- `27-02-SUMMARY.md` — Dependency graph (~3217 tok)
- `27-03-PLAN.md` — RoomPrediction: PredictionPanel, PredictionRow, runAction (~4604 tok)
- `27-03-SUMMARY.md` — Dependency graph (~3188 tok)
- `27-CONTEXT.md` — Phase 27: Room-Readiness One-Click Reassign / Escalate / Acknowledge - Context (~3120 tok)
- `27-RESEARCH.md` — Phase 27: Room-Readiness One-Click Reassign / Escalate / Acknowledge - Research (~9944 tok)
- `27-VERIFICATION.md` — Phase 27: Room-Readiness One-Click Reassign / Escalate / Acknowledge Verification Report (~3481 tok)

## .planning/phases/28-batch-actions/

- `28-01-PLAN.md` — Declares BatchRoomReadinessRequest (~2886 tok)
- `28-01-SUMMARY.md` — Dependency graph (~2274 tok)
- `28-02-PLAN.md` — Declares BatchAcknowledgePredictionsRequest (~2257 tok)
- `28-02-SUMMARY.md` — Dependency graph (~1997 tok)
- `28-03-PLAN.md` (~3025 tok)
- `28-03-SUMMARY.md` — Dependency graph (~2622 tok)
- `28-04-PLAN.md` (~2753 tok)
- `28-04-SUMMARY.md` — Dependency graph (~2910 tok)
- `28-CONTEXT.md` — Phase 28: Batch Actions - Context (~1752 tok)
- `28-RESEARCH.md` — Phase 28: Batch Actions - Research (~7448 tok)
- `28-VERIFICATION.md` — Phase 28: Batch Actions Verification Report (~2568 tok)

## .planning/phases/29-escalation-to-gm/

- `29-01-PLAN.md` (~2347 tok)
- `29-01-SUMMARY.md` — Dependency graph (~3168 tok)
- `29-02-PLAN.md` — else: risk_level == "HIGH" and previous_risk == "HIGH" -> omit escalation_level (~5149 tok)
- `29-02-SUMMARY.md` — Phase 29 Plan 02: Prediction-Engine Escalation-Watermark Carry-Forward Summary (~1646 tok)
- `29-03-PLAN.md` (~3700 tok)
- `29-03-SUMMARY.md` — Dependency graph (~2129 tok)
- `29-04-PLAN.md` — Declares currently (~4079 tok)
- `29-04-SUMMARY.md` — Phase 29 Plan 04: Reset Call Sites Summary (~2008 tok)
- `29-CONTEXT.md` — Phase 29: Escalation to GM - Context (~3208 tok)
- `29-RESEARCH.md` — Phase 29: Escalation to GM - Research (~13217 tok)
- `29-VERIFICATION.md` — Phase 29: Escalation to GM Verification Report (~3225 tok)

## .planning/phases/30-additive-foundation-regression-harness/

- `30-01-PLAN.md` — Existing Playwright wiring to mirror (structure, baseURL, headless) (~4428 tok)
- `30-01-SUMMARY.md` — Dependency graph (~3971 tok)
- `30-02-PLAN.md` — The exact precedent to mirror (front_desk_modules end to end) (~2276 tok)
- `30-02-SUMMARY.md` — Dependency graph (~1707 tok)
- `30-03-PLAN.md` — Precedent: existing locale-aware Node gate scripts to mirror in style (~1202 tok)
- `30-03-SUMMARY.md` — Dependency graph (~1127 tok)
- `30-04-PLAN.md` — The token layer being extended (additive only) (~2969 tok)
- `30-04-SUMMARY.md` — Dependency graph (~3407 tok)
- `30-05-PLAN.md` — The manifest this guard consumes (from plan 30-04) (~2584 tok)
- `30-05-SUMMARY.md` — Phase 30 Plan 05: Frozen-File Guard + Dark-Mode Contrast Gate Summary (~1982 tok)
- `30-06-PLAN.md` — The CI workflow being extended (~1853 tok)
- `30-06-SUMMARY.md` — Dependency graph (~1582 tok)
- `30-CONTEXT.md` — Phase 30: Additive Foundation & Regression Harness - Context (~1893 tok)
- `30-RESEARCH.md` — Phase 30: Additive Foundation & Regression Harness - Research (~7862 tok)
- `30-VERIFICATION.md` — Phase 30: Additive Foundation & Regression Harness Verification Report (~1958 tok)
- `FROZEN.md` — FROZEN — Phase 30 Frozen-Primitive List (FOUND-02) (~2044 tok)

## .planning/phases/31-shell-navigation-redesign/

- `31-01-PLAN.md` — NOTE on shared-file overlap: Header.tsx and CommandPalette.tsx appear here as (~4288 tok)
- `31-01-SUMMARY.md` — Phase 31 Plan 01: Shell Redesign Foundation Summary (~3120 tok)
- `31-02-PLAN.md` — Server contract to rely on (is_read truthy ⇒ returns read+unread history; DO NOT edit) (~2241 tok)
- `31-02-SUMMARY.md` — Phase 31 Plan 02: Header Notification Toggle + v2 Restyle Summary (~1771 tok)
- `31-03-PLAN.md` — Endpoints to extend (additive q param — keep tenant scoping) (~2749 tok)
- `31-03-SUMMARY.md` — Dependency graph (~3290 tok)
- `31-04-PLAN.md` — RBAC gate + the exact allow-set to reuse (~2520 tok)
- `31-04-SUMMARY.md` — Phase 31 Plan 04: Command Palette Record Search + v2 Restyle Summary (~2632 tok)
- `31-05-PLAN.md` — The pure RBAC source of truth to snapshot (READ-ONLY — never modify) (~2420 tok)
- `31-05-SUMMARY.md` — Phase 31 Plan 05: Automated RBAC Nav Matrix Test Summary (~2340 tok)
- `31-06-PLAN.md` (~2323 tok)
- `31-06-SUMMARY.md` — Phase 31 Plan 06: Shell Close-Out Verification Summary (~5175 tok)
- `31-CONTEXT.md` — Phase 31: Shell & Navigation Redesign - Context (~3056 tok)
- `31-RESEARCH.md` — Phase 31: Shell & Navigation Redesign - Research (~9414 tok)
- `31-VERIFICATION.md` — Phase 31: Shell & Navigation Redesign Verification Report (~2624 tok)

## .planning/phases/32-role-dashboard-homes/

- `32-01-PLAN.md` — NOTE on file ownership: en.ts / es.ts are edited ONLY here. This plan is the SOLE owner of (~2554 tok)
- `32-01-SUMMARY.md` — Dependency graph (~1365 tok)
- `32-02-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of page.tsx and the SOLE creator of (~3988 tok)
- `32-02-SUMMARY.md` — Dependency graph (~1502 tok)
- `32-03-PLAN.md` — NOTE: touches only these two role component files — no overlap with 32-02/04/05, runs fully (~2157 tok)
- `32-03-SUMMARY.md` — Phase 32 Plan 03: Housekeeper + Engineer Dashboard Homes Summary (~1728 tok)
- `32-04-PLAN.md` — NOTE: touches only these two role component files — no overlap with 32-02/03/05, runs fully (~2386 tok)
- `32-04-SUMMARY.md` — Phase 32 Plan 04: Supervisor + Chief Engineer Dashboard Homes Summary (~1731 tok)
- `32-05-PLAN.md` — NOTE: touches only FrontDeskDashboard.tsx — no overlap with 32-02/03/04, runs fully parallel. (~2151 tok)
- `32-05-SUMMARY.md` — Phase 32 Plan 05: Front Desk Dashboard Home Summary (~1569 tok)
- `32-06-PLAN.md` — NOTE: verification-only plan (files_modified: []), mirroring 31-06. Runs the full standing web (~2502 tok)
- `32-06-SUMMARY.md` — Dependency graph (~4644 tok)
- `32-CONTEXT.md` — Phase 32: Role Dashboard Homes - Context (~1784 tok)
- `32-RESEARCH.md` — Phase 32: Role Dashboard Homes - Research (~6873 tok)
- `32-VERIFICATION.md` — Phase 32: Role Dashboard Homes Verification Report (~2479 tok)

## .planning/phases/33-core-operational-sections/

- `33-01-PLAN.md` — NOTE on file ownership: en.ts / es.ts are edited ONLY here. This plan is the SOLE owner of (~3478 tok)
- `33-01-SUMMARY.md` — Dependency graph (~2425 tok)
- `33-02-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of tasks/page.tsx and evidence/page.tsx. (~2744 tok)
- `33-02-SUMMARY.md` — Dependency graph (~2092 tok)
- `33-03-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of sop/page.tsx and logbook/page.tsx. (~2926 tok)
- `33-03-SUMMARY.md` — Dependency graph (~2001 tok)
- `33-04-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of GuestRequestsPage.tsx and (~3865 tok)
- `33-04-SUMMARY.md` — Dependency graph (~2335 tok)
- `33-05-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of the safety/ and programs/ trees. No (~3778 tok)
- `33-05-SUMMARY.md` — Dependency graph (~3260 tok)
- `33-06-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of scheduling/page.tsx. No wave-2 sibling (~2348 tok)
- `33-06-SUMMARY.md` — Dependency graph (~1788 tok)
- `33-07-PLAN.md` — NOTE: verification-only plan (files_modified: []), mirroring 32-06. Runs the full standing web (~3061 tok)
- `33-07-SUMMARY.md` — Dependency graph (~5276 tok)
- `33-CONTEXT.md` — Phase 33: Core Operational Sections - Context (~3029 tok)
- `33-RESEARCH.md` — Phase 33: Core Operational Sections - Research (~8911 tok)
- `33-VERIFICATION.md` — Phase 33: Core Operational Sections Verification Report (~3266 tok)

## .planning/phases/34-management-admin-sections/

- `34-01-PLAN.md` — NOTE on file ownership: en.ts / es.ts are edited ONLY here. This plan is the SOLE owner of (~4459 tok)
- `34-01-SUMMARY.md` — Dependency graph (~2935 tok)
- `34-02-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of reports/page.tsx and (~3728 tok)
- `34-02-SUMMARY.md` — Dependency graph (~2274 tok)
- `34-03-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of staff/page.tsx. No sibling wave-2 plan (~3448 tok)
- `34-03-SUMMARY.md` — Dependency graph (~3248 tok)
- `34-04-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of these 3 settings/* page bodies. No (~4120 tok)
- `34-04-SUMMARY.md` — Dependency graph (~3466 tok)
- `34-05-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of settings/integrations/page.tsx. No (~2994 tok)
- `34-05-SUMMARY.md` — Dependency graph (~2433 tok)
- `34-06-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of ai/page.tsx. No sibling wave-2 plan (~2912 tok)
- `34-06-SUMMARY.md` — Dependency graph (~2442 tok)
- `34-07-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of Header.tsx and FrontDeskDashboard.tsx (~3804 tok)
- `34-07-SUMMARY.md` — Dependency graph (~2707 tok)
- `34-08-PLAN.md` — NOTE: verification-only plan (files_modified: []), mirroring 33-07/32-06. Runs the full (~3995 tok)
- `34-08-SUMMARY.md` — Dependency graph (~6116 tok)
- `34-CONTEXT.md` — Phase 34: Management & Admin Sections - Context (~2547 tok)
- `34-RESEARCH.md` — Phase 34: Management & Admin Sections - Research (~12270 tok)

## .planning/phases/35-engineering-section-chrome/

- `35-01-PLAN.md` — NOTE on file ownership: en.ts / es.ts are edited ONLY here. This plan is the SOLE owner of the (~2604 tok)
- `35-01-SUMMARY.md` — Dependency graph (~1669 tok)
- `35-02-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of work-orders/page.tsx and (~4661 tok)
- `35-02-SUMMARY.md` — Dependency graph (~1726 tok)
- `35-03-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of these 4 files. No sibling wave-2 plan (~4673 tok)
- `35-03-SUMMARY.md` — Dependency graph (~2231 tok)
- `35-04-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of assets/page.tsx. No sibling wave-2 plan (~3350 tok)
- `35-04-SUMMARY.md` — Dependency graph (~2029 tok)
- `35-05-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of these 2 files. No sibling wave-2 plan (~3261 tok)
- `35-05-SUMMARY.md` — Dependency graph (~2100 tok)
- `35-06-PLAN.md` — NOTE on file ownership: this plan is the SOLE editor of predictions/page.tsx. No sibling wave-2 (~2870 tok)
- `35-06-SUMMARY.md` — Dependency graph (~1622 tok)
- `35-07-PLAN.md` — NOTE: this close-out plan is NOT files_modified: [] like 33-07/34-08's pure-verification (~5748 tok)
- `35-07-SUMMARY.md` — Dependency graph (~6396 tok)
- `35-CONTEXT.md` — Phase 35: Engineering Section Chrome - Context (~3032 tok)
- `35-RESEARCH.md` — Phase 35: Engineering Section Chrome - Research (~11479 tok)

## .planning/research/

- `ARCHITECTURE.md` — Architecture Research (~4536 tok)
- `FEATURES.md` — Feature Research (~4042 tok)
- `PITFALLS.md` — Pitfalls Research (~7180 tok)
- `STACK.md` — Stack Research (~4098 tok)
...
- `scheduler.py` — In-process cron scheduler. (~1382 tok)
...
- `requests.py` — Pydantic: SanitizedBaseModel (~13593 tok)

## apps/api/routers/

- `ai_copilot.py` — API: 1 endpoints (~12345 tok)
- `assets.py` — API: 11 endpoints (~5782 tok)
- `auth.py` — API: 2 endpoints (~602 tok)
- `guest_requests.py` — API: 3 endpoints (~7609 tok)
- `housekeeping.py` — Declares from (~26917 tok)
- `internal.py` — API: 6 endpoints (~9926 tok)
- `tasks.py` — API: 7 endpoints (~2976 tok)
- `work_orders.py` — API: 5 endpoints (~7203 tok)

## apps/api/scripts/

- `check_bare_role_comparisons.py` — Detect "bare" role comparisons in apps/api/routers/*.py -- i.e. a `<name>.role == (~1959 tok)
- `cleanup_test_data.py` — discover_tenant_tables, run_guardrails, count_or_delete, execute_with_fk_retry (~2571 tok)
...
- `failure_predictions.py` — notify_engineers_asset_risk_high (~7882 tok)
- `predictions.py` — get_at_risk_rooms, get_housekeeper_profile, count_rooms_ahead, notify_supervisors_high_risk (~5559 tok)
...
- `test_ai_copilot_rbac.py` — RBAC matrix + tenant-isolation + confirm_tasks validation tests for ai_copilot.py. (~2759 tok)
- `test_asset_failure_batch_actions.py` — Phase 28-02 tests for asset failure-prediction batch acknowledge. (~2559 tok)
- `test_asset_prediction_actions.py` — Phase 29-04 tests for asset-failure single-item action escalation-watermark reset. (~878 tok)
- `test_cron_scheduler.py` — The in-process cron scheduler must register every job with the right schedule (~699 tok)
- `test_failure_prediction_notifications.py` — Proactive asset-failure-risk notifications (Phase 25). (~5280 tok)
- `test_prediction_escalations.py` — Single-tier GM escalation cron for HIGH-risk predictions (AI-12, AI-14). (~1662 tok)
- `test_room_readiness_actions.py` — Phase 27 tests for room-readiness one-click reassign / escalate / acknowledge. (~6392 tok)
- `test_room_readiness_batch_actions.py` — Phase 28-01 tests for room-readiness batch reassign / batch acknowledge. (~4138 tok)
- `test_work_order_archive.py` — Phase 15 contract tests for work-order bulk-archive. (~5037 tok)
...
- `fake_supabase.py` — Richer in-memory Supabase fake for clean-sessions / checklists / shifts tests. (~2287 tok)
- `test_bare_role_comparison_guard.py` — test_no_unlisted_bare_role_comparisons (~623 tok)
- `test_tenant_isolation.py` — _FakeAdminAuth: list_users, invite_user_by_email, table, b_row + 17 more (~10822 tok)
...
- `.tmp-verify-breadcrumbs.mjs` — Declares BASE (~275 tok)
- `.tmp-verify-sidebar.mjs` — Declares BASE (~1007 tok)
- `check429_tmp.mjs` — Declares BASE (~381 tok)
- `flip_flag_tmp.mjs` — Declares loadEnvFileFallback (~385 tok)
- `flip_tenant_tmp.mjs` — Declares loadEnvFileFallback (~407 tok)
- `force_error_tmp.mjs` — BASE: loadEnvFileFallback (~840 tok)
- `frozen-files-allowlist.json` (~147 tok)
- `frozen-files.json` (~1283 tok)
- `next.config.mjs` — isDev: getLocalDevOrigins, buildCSP, buildSecurityHeaders (~803 tok)
- `package.json` — Node.js package manifest (~765 tok)
- `playwright.regression.config.ts` — Declares baseURL (~339 tok)
- `recheck_sched_tmp.mjs` — Declares BASE (~329 tok)
- `restore_flags_tmp.mjs` — Declares loadEnvFileFallback (~355 tok)
- `tailwind.config.ts` — /*.{js,ts,jsx,tsx,mdx}', (~1370 tok)
- `verify_final_tmp.mjs` — BASE: loadEnvFileFallback, setFlags, login, captureNetwork (~1084 tok)
- `verify_fix_tmp.mjs` — BASE: login (~475 tok)
- `verify_sections_tmp.mjs` — BASE: isRealError, login, checkSection, main (~1284 tok)
- `verify_tmp.mjs` — Declares BASE (~502 tok)
- `verify35-column-error.mjs` — BASE: login, main (~686 tok)
- `verify35-debug.mjs` — BASE: main (~372 tok)
- `verify35-flagoff.mjs` — BASE: login, main (~550 tok)
- `verify35-statecheck.mjs` — BASE: login, toggleToSpanish, main (~1363 tok)
- `verify35-statecheck2.mjs` — BASE: login, toggleToSpanish, main (~1275 tok)
- `verify35-toggle.mjs` — BASE: login, main (~671 tok)

## apps/web/app/

- `globals.css` — Styles: 18 rules, 145 vars (~2056 tok)
...
- `page.tsx` — DashboardPage (~502 tok)
...
- `page.tsx` — todayIso (~10766 tok)

## apps/web/app/(dashboard)/lost-found/

- `page.tsx` — STATUS_TONE — renders form (~7790 tok)

## apps/web/app/(dashboard)/management-roi/

- `page.tsx` — toLocalDateStr (~5830 tok)
...
- `page.tsx` — ProgramMetric (~1248 tok)

## apps/web/app/(dashboard)/reports/

- `page.tsx` — dynamic (~9787 tok)

## apps/web/app/(dashboard)/safety/

- `page.tsx` — STATUS_STYLE — renders form (~2178 tok)

## apps/web/app/(dashboard)/scheduling/

- `page.tsx` — DEPARTMENTS (~16690 tok)
...
- `page.tsx` — numberOrDefault (~6631 tok)
...
- `page.tsx` — CATEGORY_LABELS (~1248 tok)
...
- `page.tsx` — relativeTime (~8321 tok)
...
- `page.tsx` — CATEGORIES (~8513 tok)

## apps/web/app/(dashboard)/staff/

- `page.tsx` — ROLE_OPTIONS (~15005 tok)

## apps/web/app/(dashboard)/tasks/

- `page.tsx` — getTaskTypeOptions — renders form (~11294 tok)
...
- `AIRiskAlertsPanel.tsx` — AIRiskAlertsPanel (~1816 tok)
- `ChiefEngineerDashboard.tsx` — SkeletonRow (~7555 tok)
- `EngineerDashboard.tsx` — PRIORITY_TONE (~3150 tok)
- `FrontDeskDashboard.tsx` — getHotelIdFromSession (~12185 tok)
- `GMDashboard.tsx` — getHotelIdFromSession (~4670 tok)
- `HousekeeperDashboard.tsx` — STATUS_TONE (~5107 tok)
- `SupervisorDashboard.tsx` — QUICK_MESSAGES (~10935 tok)

## apps/web/components/engineering/

- `ArchivedWorkOrdersPanel.tsx` — ArchivedWorkOrdersPanel (~1279 tok)
- `BulkArchiveModal.tsx` — ARCHIVABLE_STATUSES (~2333 tok)
- `CreateWorkOrderModal.tsx` — getCategories (~5712 tok)
- `FailurePredictionSidebar.tsx` — getRiskRingColor (~3218 tok)
- `PMCompletionModal.tsx` — genId (~8768 tok)
- `WorkOrderDetailDrawer.tsx` — CATEGORY_ICONS (~14967 tok)

## apps/web/components/guest-requests/

- `GuestRequestsPage.tsx` — timeAgo (~5305 tok)

## apps/web/components/housekeeping/

- `PredictionPanel.tsx` — formatETA (~6270 tok)
- `RoomStatusBoard.tsx` — getCleanTypeChips (~8990 tok)

## apps/web/components/programs/

- `DeepCleanAreasPanel.tsx` — OVERVIEW_KEY — renders form (~3289 tok)
- `HousekeepingDepthPanels.tsx` — OVERVIEW_KEY — renders form (~3842 tok)
- `InspectionDepthPanel.tsx` — OVERVIEW_KEY — renders form (~2625 tok)

## apps/web/components/safety/

- `ComplianceDashboard.tsx` — STATUS_STYLE — renders form, table (~2352 tok)
- `IncidentReview.tsx` — EVENT_TYPES — renders form (~1640 tok)
- `SafetyInformation.tsx` — SafetyInformation (~1680 tok)
- `SafetyPrograms.tsx` — DRILL_TYPES — renders form (~3002 tok)
...
- `Breadcrumbs.tsx` — Renders in the PageHeader `eyebrow` slot on sub-routes (e.g. Engineering → Work Orders). (~658 tok)
- `CommandPalette.tsx` — Global ⌘K / Ctrl-K palette. Lists the current user's allowed nav routes — (~3569 tok)
- `DashboardShell.tsx` — DashboardShell (~638 tok)
- `Header.tsx` — Header (~4796 tok)
- `MobileFloorNav.tsx` — Bottom tab bar for floor roles only — managers keep the sidebar + mobile drawer. (~910 tok)
- `PageHeader.tsx` — Per-tab override — see PageHeaderProps.dataI18nSkip. Independent of the page-level prop since some c (~1098 tok)
- `Providers.tsx` — SUPABASE_DB_ROLES (~2719 tok)
- `RedesignGate.tsx` — RedesignGate (~113 tok)
- `Sidebar.tsx` — Wraps `children` (a single focusable element) in a right-side tooltip when `collapsed`; passes throu (~4732 tok)
...
- `.debug-notif.mjs` — BASE: main (~358 tok)
- `.debug-palette.mjs` — BASE: main (~820 tok)
- `.live-verify-tmp.mjs` — BASE: log, login, main (~2302 tok)
- `.tmp-debug-rooms.mjs` — Declares lines (~413 tok)
- `.tmp-debug-rooms2.mjs` — Declares lines (~465 tok)
- `.tmp-shell-screenshot.mjs` — Declares lines (~428 tok)
- `.tmp-shell-screenshot2.mjs` — Declares lines (~373 tok)
- `.tmp-verify-notif.mjs` — Declares lines (~412 tok)
- `.tmp-verify-notif2.mjs` — Declares lines (~348 tok)
- `.tmp-verify-notif3.mjs` — Declares lines (~528 tok)
- `.tmp-verify-notif4.mjs` — Declares lines (~515 tok)
- `.tmp-verify-post-deploy.mjs` — Declares lines (~558 tok)
- `global-setup.ts` — Playwright globalSetup for the FOUND-03 regression harness. (~924 tok)
- `room-board-baseline.spec.ts` — FOUND-03 — Regression pixel-diff baseline for the 3 excluded Room Board (~2040 tok)
- `tmp-check-fixture.mjs` — Declares envText (~222 tok)
- `tmp-check-role-es.mjs` — Declares role (~187 tok)
- `tmp-debug-rooms.mjs` — Declares browser (~237 tok)
- `tmp-error-state.mjs` — Declares SCRATCH (~270 tok)
- `tmp-es-toggle.mjs` — Declares SCRATCH (~279 tok)
- `tmp-loading-state.mjs` — Declares SCRATCH (~221 tok)
- `tmp-login-all.mjs` — Declares envText (~502 tok)
- `tmp-magiclink.mjs` — Declares envText (~426 tok)
- `tmp-single-shot.mjs` — Declares SCRATCH (~264 tok)
- `tmp-verify-homes.mjs` — SCRATCH: initScript (~591 tok)
- `tmp-zoom.mjs` — Declares browser (~193 tok)

## apps/web/e2e/fixtures/

- `seed-regression-tenant.mjs` — Seeds (idempotently) the FOUND-03 regression fixture tenant: a dedicated, (~3348 tok)
...
- `en.ts` — Declares en (~20316 tok)
- `es.ts` — Declares es (~22294 tok)
...
- `ai.ts` — ── Types ──────────────────────────────────────────────────────────────────── (~1485 tok)
- `engineering.ts` — ─── Work Order types ───────────────────────────────────────────────────────── (~3053 tok)
- `guest_requests.ts` — API routes: GET, POST, PATCH, DELETE, PUT (15 endpoints) (~1684 tok)
- `hotels.ts` — API routes: POST, GET, PATCH (4 endpoints) (~482 tok)
- `housekeeping.ts` — API routes: GET, POST, DELETE, PATCH (34 endpoints) (~2548 tok)
...
- `_gen-matrix.tmp.ts` — Declares ROLES (~115 tok)
- `navigation.matrix.json` (~303 tok)
- `navigation.test.ts` — ROLES: buildMatrix (~462 tok)
- `redesignFlag.test.mjs` (~204 tok)
- `redesignFlag.ts` — Exports isSectionRedesigned (~64 tok)
...
- `_temp-check-dom.mjs` — Declares BASE (~670 tok)
- `_temp-check-dom2.mjs` — BASE: checkPage (~446 tok)
- `_temp-check-dom3.mjs` — Declares BASE (~357 tok)
- `_temp-check-dom4.mjs` — Declares BASE (~318 tok)
- `_temp-check-dom5.mjs` — Declares BASE (~511 tok)
- `_temp-check-statblock.mjs` — Declares BASE (~406 tok)
- `_temp-flip-fixture-flag.mjs` — TEMP (34-08 close-out verification) — flip/restore the FOUND-03 regression fixture (~502 tok)
- `_temp-recheck-billing.mjs` — Declares BASE (~401 tok)
- `_temp-recheck-integrations.mjs` — Declares BASE (~422 tok)
- `_temp-recheck-integrations2.mjs` — Declares BASE (~580 tok)
- `_temp-verify-ai-chat.mjs` — Declares BASE (~349 tok)
- `_temp-verify-ai-notif.mjs` — ', (route) => route.fulfill({ status: 500, body: JSON.stringify({ detail: 'forced failure' }) })) (~696 tok)
- `_temp-verify-flagoff.mjs` — Declares BASE (~476 tok)
- `_temp-verify-login.mjs` — Declares BASE (~272 tok)
- `_temp-verify-sections.mjs` — BASE: setPrefs (~1022 tok)
- `_temp-verify-sections2.mjs` — Declares BASE (~784 tok)
- `check-contrast.mjs` — Dark-mode WCAG AA contrast gate (FOUND-04). Pure-Node relative-luminance (~2522 tok)
- `check-frozen-files.mjs` — Frozen-file + room-status-value guard (FOUND-02). Mirrors (~2684 tok)
- `check-i18n-parity.mjs` — FOUND-05: EN/ES i18n key-parity gate. (~1121 tok)

## apps/web/stores/

- `hotelStore.ts` — Exports Hotel, useHotelStore (~307 tok)
- `uiPreferencesStore.ts` — Exports useUIPreferencesStore (~341 tok)
...
- `095_room_readiness_acknowledgement.sql` — Migration 095: Room-readiness prediction acknowledgement (Phase 27, AI-05) (~285 tok)
- `096_prediction_escalation_watermark.sql` — Migration 096: Escalation watermark for HIGH-risk predictions (Phase 29, AI-12/13/14) (~657 tok)
- `097_web_redesign_sections.sql` (~140 tok)
