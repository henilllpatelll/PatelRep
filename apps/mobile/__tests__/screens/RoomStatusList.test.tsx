...
const rooms = [
  ...
  { id: "r4", room_number: "204", floor: 2, status: "PICKUP", fo_status: null, vip_flag: false, dnd_flag: false, guest_name: "Guest B", checkout_time: null },
];
...
describe("RoomStatusScreen", () => {
  it("lists all rooms grouped by floor", async () => {
