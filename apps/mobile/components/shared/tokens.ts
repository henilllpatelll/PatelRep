...
/* ─── PatelRep Mobile — Warm Operational Hospitality palette ────────────────
   Warm paper canvas with forest-green primary action. Status colors are a
   protected contract shared with the web app: teal ready, blue clean, rose
   dirty/occupied, amber pickup, stone out-of-order. Do not change their
   meanings or hues. */
