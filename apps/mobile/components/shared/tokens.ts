...
/* ─── PatelRep Mobile — "Evening Lobby" design system ───────────────────────
   ...
   canvas. Terracotta action accent. Status colors are a protected contract
...
export const darkTheme = {
  ...
  borderSubtle: "#2B2720",
  primary: "#D97757",
  primaryAction: "#D97757",
  primaryHover: "#E08A6D",
  primarySoft: "rgba(217, 119, 87, 0.16)",
  primaryLine: "rgba(217, 119, 87, 0.36)",
  accentBrass: "#D0A85A",
  accentClay: "#C98262",
...
export const C = {
  ...
  accentHover: lightTheme.primaryHover,
