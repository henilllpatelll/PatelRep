...
async def onboarding_ai_assistant(
    ...
    STEP_CONTEXT = {
        ...
        3: "The GM is inviting staff. Roles available: housekeeping_supervisor (manages HK team + inspections), housekeeper (marks rooms clean on mobile), engineer (manages and completes work orders, PM schedules, OOO), front_desk (creates guest requests, views room status).",
