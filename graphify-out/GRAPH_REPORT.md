...
Cohesion: 0.07
Nodes (42): AIUsageReport, DailySummary, MaintenanceReport, reportsApi, StaffMetric, StaffPerformanceReport, PRIORITY_TONE, STATUS_LABEL (+34 more)
...
Cohesion: 0.10
Nodes (24): billingApi, CreditUsage, Invoice, Subscription, creditBarColor(), formatCents(), formatDate(), formatNumber() (+16 more)
...
Cohesion: 0.11
Nodes (25): AIRiskAlertsPanel(), ChiefEngineerDashboard(), EngineerDashboard(), FrontDeskDashboard(), getHotelIdFromSession(), GuestRequestRow(), REQUEST_STATUS_TONE, ROOM_STATUS_CONFIG (+17 more)
...
Cohesion: 0.10
Nodes (14): GuestRequestStatus, staffApi, ActiveTab, CreateRequestModalProps, EditRequestModal(), EditRequestModalProps, GuestRequestCardProps, GuestRequestsPage() (+6 more)

### Community 67 - "Community 67"
Cohesion: 0.12
Nodes (21): AICopilotBubble.tsx — Floating AI Chat Component, amber-* Tailwind Tokens (Brand Color), ARIA Modal Pattern (role=dialog, aria-modal, focus trap), CORS Auth Issue — /v1/auth/me Intermittent Failures, Dashboard Stat Cards Never Resolve from Skeleton (C-01), Floating AI Button Overlaps Mobile Content, Frontend Audit — PatelRep Dashboard, Frosted Glass — Overlays Only (Cerebrum Rule) (+13 more)

### Community 68 - "Community 68"
Cohesion: 0.17
Nodes (19): CurrentUser, int, str, CurrentUser, int, str, CreateGuestRequestRequest, middleware/auth.py — JWT Validation (+11 more)
...
Cohesion: 0.15
Nodes (14): CI: Lint API (ruff check), CI: Lint Web (ESLint + TypeScript), CI: Test API (pytest smoke tests), GitHub Actions Deploy Workflow, HousekeeperDashboard.tsx, housekeepingDashboardMetrics.ts — Live Metric Derivation, SupervisorDashboard.tsx, Next.js 14 Web Dashboard (apps/web) (+6 more)
...
Cohesion: 0.40
Nodes (5): DO-NOT-REPEAT: Opera auth_code OAuth Redirect, Opera Cloud Integration (A4) — Feature-Flagged, integrations.py Router (Opera), services/opera/ — Opera Integration Service, Services Layer Depth (A1) — Keep Logic in Routers
